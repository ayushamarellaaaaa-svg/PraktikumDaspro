...
public class Latihan7 {
   public static void main(String[] args) {
        ...
        double sisaBiaya;
        String bantuan;
        double presentaseBantuan;

        System.out.println("Apakah pihak Polinema bersedia memberikan dana bantuan? (ya/tidak)");
        bantuan = sc.next();

        if (bantuan.equalsIgnoreCase("ya")) {
            System.out.println("Masukkan presentase dana bantuan Polinema (contoh : 60) = ");
            presentaseBantuan = sc.nextDouble();
            danaPolinema = (presentaseBantuan / 100) * totalAnggaran;
        } else {
            danaPolinema = 0;
        }
